...
import affiliatesSaga from "../affiliates/store/saga";

export default function* rootSaga() {
  yield all([alertSaga(), dataSaga(), authSaga(), profileSaga(), dashboardSaga(), accountsSaga(), exchangeSaga(), affiliatesSaga()]);
}
