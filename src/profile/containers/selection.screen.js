...
export const ModalInformation = () => {
  ...
  return (
    <div className="text-center">
      ...
      <p className="my-3">
        Gracias por la confianza, queremos informarle que en estos momentos la plataforma para empresas de <b>Interbank</b> presenta problemas en su plataforma. Por tal movito las
        operaciones a <b>Interbank</b> pueden demorar más de la usual. Estamos a la espera del banco que solucione a la brevedad posible.
      </p>
