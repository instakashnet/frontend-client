...
export const InfoModal = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center">
      ...
      <p>
        Gracias por la confianza, queremos informarle que desde hace días la plataforma para empresas de <b>Interbank</b> posee problemas en su plataforma, por tal motivo no
        podremos realizar solicitues hacia este banco por el momento.
