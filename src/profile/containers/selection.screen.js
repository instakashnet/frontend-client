...
export const ModalInformation = () => {
  ...
  return (
    <div className="text-center">
      ...
      <p className="my-3">
        Gracias por la confianza, queremos informarle que en estos momentos para empresas de <b>BCP</b> presenta problemas en su plataforma. Por tal movito no podremos realizar
        operaciones a este banco. Estamos a la espera del banco que solucione a la brevedad posible.
      </p>
