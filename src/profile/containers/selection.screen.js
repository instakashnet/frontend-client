...
export const ModalInformation = () => {
  ...
  return (
    <div className="text-center">
      ...
      <p className="my-3">
        Gracias por la confianza, queremos informarle que en estos momentos la plataforma para empresas de <b>BCP</b> presenta problemas en su plataforma. Por tal motivo, las
        operaciones a este banco pueden demorar más de lo usual. Estamos a la espera del banco que solucione a la brevedad posible.
      </p>
