...
// CLASSES
import classes from "./modules/rates-modal.module.scss";

function UpdateRates({ onClose }) {
  return (
    <div className={`flex flex-col items-center justify-center pt-4 pb-1 mx-auto ${classes.UpdRatesContainer}`}>
