  ...
  return (
    <>
      <p className="mb-3 text-center">
        Agradecidos siempre por la confianza, queremos informarle que la plataforma de <b>Interbank</b> se encuentra con frecuentes retrasos para procesar transferencias, por ello
